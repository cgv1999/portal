...
// Данные из JSON (будут загружены отдельно)
let royaltyData = [];
...
function populateFilters(data) {
    console.log('Загрузка фильтров для данных франчайзи...');
...
function buildChart(data, selectedObjects) {
    ...
    if (selectedObjects) {
        if (selectedObjects.includes('all_franchise')) {
            subtitle += ` | Все франчайзи (${franchiseObjects.length} объектов)`;
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (typeof royaltyData !== 'undefined' && royaltyData.length > 0) {
        ...
        console.log('Загружено записей:', companyData.length);
        ...
        document.getElementById('chartLoading').textContent = 'Ожидание загрузки данных...';
    }
});